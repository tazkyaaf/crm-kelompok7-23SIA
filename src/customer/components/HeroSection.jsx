...
import "./HeroSection.css"; // Pastikan CSS animasi dimuat
...
const HeroSection = ({ onSeeAll }) => (
  <section className="bg-[#f8fdff] relative overflow-hidden flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-16 md:py-24">
    ...
    <div className="md:w-1/2 w-full relative flex justify-center items-center z-10 md:pl-16">
      ...
      <div className="absolute bg-[#c8e2fb] w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 -z-10 opacity-70"></div>
     ...
     <div className="absolute left-[10px] md:left-[20px] flex flex-col gap-6 z-20">

        <div className="bg-white rounded-2xl p-4 shadow-lg w-20 md:w-24 animate-float-slow">
          <img src="/assets/hero-icon1.png" alt="Pickup Icon" className="w-full" />
        </div>
...
<div className="absolute top-1/2 left-1/2 w-16 h-16 rounded-full shadow-md transform -translate-x-1/2 -translate-y-1/2 animate-bubble-slow bg-gradient-to-br from-white to-[#b3d9ff] opacity-80"></div>

{/* Gelembung kecil lainnya */}
<div className="absolute top-[55%] left-[60%] w-6 h-6 rounded-full shadow-md bg-gradient-to-br from-white to-[#c5e5ff] opacity-70 animate-bubble"></div>
<div className="absolute top-[65%] left-[58%] w-4 h-4 rounded-full shadow-md bg-gradient-to-br from-white to-[#d2ecff] opacity-60 animate-bubble-fast"></div>
<div className="absolute top-[60%] left-[63%] w-3 h-3 rounded-full shadow-md bg-gradient-to-br from-white to-[#e1f4ff] opacity-50 animate-bubble"></div>
</section>
);
